...
//		movie_id -> 0
		if(Strings.isNullOrEmpty(cols[5])) {
			...
			String movieId = String.valueOf(cols[5]);
...
//		releaseDate -> 2
		if(Strings.isNullOrEmpty(cols[14])) {
...
//		spokenLanguages -> 5
		if(Strings.isNullOrEmpty(cols[17])) {
...
//		revenue -> 7
		if(Strings.isNullOrEmpty(cols[15])) {
...
//		runtime -> 8
		if(Strings.isNullOrEmpty(cols[16])) {
...
//		voteAvg -> 10
		if(Strings.isNullOrEmpty(cols[22])) {
